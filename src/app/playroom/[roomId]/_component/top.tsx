        ...
        <div className='top-1/2 left-1/2 mx-auto text-center'>
            ...
            <div className='flex flex-row  '>
                ...
                <div className='flex flex-row space-x-4'>
                    ...
                    {/* <Image src={VideoImage} className="  max-w-52 block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."/> */}
                    {/* <Image src={VideoImage} className=" block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."/> */}
                    {/* <Image src={VideoImage} className=" block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."/> */}
                </div>
            ...
            {/* <div id="controls-carousel" className="relative w-full" data-carousel="static">
                ...
                <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
                    ...
                    <div className="hidden duration-700 ease-in-out" data-carousel-item>
                        <Image src={VideoImage} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..."/>
                    </div>
